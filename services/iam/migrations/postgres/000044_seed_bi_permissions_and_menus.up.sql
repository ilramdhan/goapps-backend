...
INSERT INTO mst_menu (menu_id, parent_id, menu_code, menu_title, menu_url, icon_name, service_name, menu_level, sort_order, is_visible, is_active, created_by)
VALUES
    ('00000000-0000-0000-0003-000000000030', '00000000-0000-0000-0002-000000000020', 'BI_VIEWER_LIST', 'Dashboards',  '/finance/bi',         'LayoutDashboard', 'finance', 3, 10, true, true, 'seed'),
    ('00000000-0000-0000-0003-000000000031', '00000000-0000-0000-0002-000000000020', 'BI_ADMIN',       'Admin Panel', '/finance/bi/admin',   'Settings',        'finance', 3, 20, true, true, 'seed'),
    ('00000000-0000-0000-0003-000000000032', '00000000-0000-0000-0002-000000000020', 'BI_UPLOAD',      'Upload Data', '/finance/bi/upload',  'Upload',          'finance', 3, 30, true, true, 'seed')
ON CONFLICT (menu_code) DO NOTHING;
...
SELECT '00000000-0000-0000-0003-000000000030', permission_id, 'seed'
FROM mst_permission
...
INSERT INTO menu_permissions (menu_id, permission_id, assigned_by)
SELECT '00000000-0000-0000-0003-000000000031', permission_id, 'seed'
FROM mst_permission
...
INSERT INTO menu_permissions (menu_id, permission_id, assigned_by)
SELECT '00000000-0000-0000-0003-000000000032', permission_id, 'seed'
FROM mst_permission
