...
## [0.16.0](https://github.com/ilramdhan/goapps-backend/compare/iam-service/v0.15.1...iam-service/v0.16.0) (2026-07-01)


### Features

* **auth:** support internal service token bypass for trusted backend callers ([24aaafe](https://github.com/ilramdhan/goapps-backend/commit/24aaafe3e99836ae0e9ebf1afacc4af97147e511))
* **bi-service:** Enhance BI module with migrations, dashboard features, and gRPC support ([060b249](https://github.com/ilramdhan/goapps-backend/commit/060b2495db306f617b04385f1f68bdbecc483f17))
* **bi:** add EBITDA + NET_PROFIT per-dashboard sidebar menu entries (IAM 000047) ([cc97e61](https://github.com/ilramdhan/goapps-backend/commit/cc97e6139a004e5ea28d9d7aa146bcd77e4a15c4))
* **bi:** seed DELIVERY_MARGIN dashboard config + IAM menu/permissions (000324+000046) ([ab4dcef](https://github.com/ilramdhan/goapps-backend/commit/ab4dcefdc7bdb9c569697aeb991d40eed8c99299))
...
* **export-notification:** Implement generic IAM notification system with MinIO export support ([124f619](https://github.com/ilramdhan/goapps-backend/commit/124f619c16e4f2ef5bc70c975fc9e40deb2e1244))
...
* **iam:** commit PRD v1.3 batch — company-mapping, approval workflow, encrypted chat ([ce4da89](https://github.com/ilramdhan/goapps-backend/commit/ce4da8924091c890406d5c9d0c0459ff17c9da2c))
...
* **iam:** seed BI permissions, menus, and SUPER_ADMIN role assignments ([23b7dda](https://github.com/ilramdhan/goapps-backend/commit/23b7ddae8b7f37d951e4e59eb141cc29c5b68b2d))
* **iam:** seed calc jobs + cost results sidebar menus ([6874c9b](https://github.com/ilramdhan/goapps-backend/commit/6874c9b6921d2869bb0d6cc4e9223b2c864c25b9))
...
* **iam:** seed permissions for cost calc engine ([979590e](https://github.com/ilramdhan/goapps-backend/commit/979590eeef97cede35f86739e7433c1caba3b19e))
* **iam:** seed product costing permissions + sidebar menu (phase 1) ([2f9a284](https://github.com/ilramdhan/goapps-backend/commit/2f9a2845c9f774db90149e8eaca2520aec5ade5a))
...
* **notification:** add generic IAM notification system with SSE realtime delivery ([7682d14](https://github.com/ilramdhan/goapps-backend/commit/7682d1499e85285f728f9c7dd8cfa18725a2724f))
* **product-cost:** Implement product costing system with migrations, handlers, and services ([173ddc6](https://github.com/ilramdhan/goapps-backend/commit/173ddc60c61e280da79ef78401ce0e73dd207a80))


### Bug Fixes

* **bi-dashboard:** Enhance BI metrics and dashboards with schema v1.1 updates ([bbb088d](https://github.com/ilramdhan/goapps-backend/commit/bbb088d8cd7c199f936113f11731506dd76a711c))
...
* Dynamic YTD KPI for BI Dashboards & IAM Menu Permissions ([#115](https://github.com/ilramdhan/goapps-backend/issues/115)) ([69e9171](https://github.com/ilramdhan/goapps-backend/commit/69e9171597b06b47b512dd46b151ee1ed7cf51ab))
* **iam:** add audit fields + soft-delete guard to migration 000045 ([b098fa8](https://github.com/ilramdhan/goapps-backend/commit/b098fa8d338b0ac8ddf7507bc73294795b891feb))
...
* **iam:** correct FINANCE_PRODUCT_ORDERS menu url to /finance/routes ([7a1c989](https://github.com/ilramdhan/goapps-backend/commit/7a1c989407e258725634f1d713a34fb4b1ec0f8d))
* **iam:** correct FINANCE_PRODUCT_ORDERS menu url to /finance/routes ([0bc4606](https://github.com/ilramdhan/goapps-backend/commit/0bc4606f7930093d317ab3b31d6db5dae0155374))
...
* **iam:** gate RM Pricing and Product Costing parent menus ([082fd67](https://github.com/ilramdhan/goapps-backend/commit/082fd6721bf75e067d8c170369a92cbbaabd39e7))
...
* **iam:** resolve golangci-lint v2.3.0 CI failures (74 issues → 0) ([b33f749](https://github.com/ilramdhan/goapps-backend/commit/b33f7498af9fe51498e22d7d06a15654a6bfa82d))
...
* **lint:** resolve golangci-lint errors and apply Copilot review feedback ([9b96fd5](https://github.com/ilramdhan/goapps-backend/commit/9b96fd5fc97b200577cca144b5d3656a6930f639))
...
* **lint:** resolve remaining gocyclo, gocognit, and errorlint failures ([962dcfd](https://github.com/ilramdhan/goapps-backend/commit/962dcfdad6700bb843643589396696dc7b4d4221))
...
* **notification:** suppress nilerr on intentional bad-cursor swallow ([bcc6a50](https://github.com/ilramdhan/goapps-backend/commit/bcc6a5024e2322fd58835d3c77e2ff625461933f))
...
* **tracing:** fetch tracer lazily per-request to survive late provider init ([0186299](https://github.com/ilramdhan/goapps-backend/commit/018629984683afb9ba47c9f02ee198a36f835336))
* **tracing:** fetch tracer lazily per-request to survive late provider init ([788d0bc](https://github.com/ilramdhan/goapps-backend/commit/788d0bc6c0db634bd90430354542d21086b541a5))
* **tracing:** use otlptracegrpc.WithInsecure() to actually disable TLS ([0908955](https://github.com/ilramdhan/goapps-backend/commit/090895526959ecbc8deaa37a8f7fc1dc661aa8b7))
