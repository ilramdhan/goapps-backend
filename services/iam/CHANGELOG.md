...
## [0.6.0](https://github.com/ilramdhan/goapps-backend/compare/iam-service/v0.5.0...iam-service/v0.6.0) (2026-04-07)


### Features

* Add build and copy steps for the `iam-seed` binary. ([b55b3f8](https://github.com/ilramdhan/goapps-backend/commit/b55b3f89c6b4a66511a944ae7ad1ec9933793110))
* Add golang-migrate and migration files to the IAM service Dockerfile for database migrations. ([1de4a14](https://github.com/ilramdhan/goapps-backend/commit/1de4a147c48dc90e56e40c0fd0e1ee4f00834e05))
* Add MinIO storage integration and user profile picture upload functionality. ([2754734](https://github.com/ilramdhan/goapps-backend/commit/27547346f3a6096fe3d4672a8fa7508f9835f2c3))
* Add MinIO storage integration and user profile picture upload functionality. ([8c8d7c0](https://github.com/ilramdhan/goapps-backend/commit/8c8d7c042e497002579b078fb57c6d2fb3ef9ff4))
...
* lint check. ([84ef101](https://github.com/ilramdhan/goapps-backend/commit/84ef10161e9a600e55b3679c6c82cce33003eb2c))
