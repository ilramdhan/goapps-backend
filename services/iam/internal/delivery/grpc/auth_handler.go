...
func (h *AuthHandler) resolveOrgInfo(ctx context.Context, userID uuid.UUID) (sectionID, departmentID, sectionCode, departmentCode string) { //nolint:gocognit,gocyclo // cohesive function; complexity inherent
