...
func TestNew_Success(t *testing.T) {
	name := "MB Head A"
	e, err := mbhead.New("MBH-2024-001", nil, &name, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin", false, "", "", "", "", "", nil)
...
func TestNew_EmptyMBCosting(t *testing.T) {
	_, err := mbhead.New("", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin", false, "", "", "", "", "", nil)
	assert.ErrorIs(t, err, mbhead.ErrEmptyMBCosting)
}

func TestNew_EmptyCreatedBy(t *testing.T) {
	_, err := mbhead.New("MBH-2024-001", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", false, "", "", "", "", "", nil)
	assert.ErrorIs(t, err, mbhead.ErrEmptyCreatedBy)
}

func TestSoftDelete_AlreadyDeleted(t *testing.T) {
	e, err := mbhead.New("MBH-2024-001", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin", false, "", "", "", "", "", nil)
	require.NoError(t, err)
