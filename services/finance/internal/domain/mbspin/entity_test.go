...
func TestNew_Success(t *testing.T) {
	headID := uuid.New()
	e, err := mbspin.New(headID, "MB Spin A", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
...
func TestNew_InvalidHeadID(t *testing.T) {
	_, err := mbspin.New(uuid.Nil, "MB Spin A", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
	assert.ErrorIs(t, err, mbspin.ErrInvalidHeadID)
}

func TestNew_EmptyMgtName(t *testing.T) {
	headID := uuid.New()
	_, err := mbspin.New(headID, "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
	assert.ErrorIs(t, err, mbspin.ErrEmptyMgtName)
}

func TestNew_EmptyCreatedBy(t *testing.T) {
	headID := uuid.New()
	_, err := mbspin.New(headID, "MB Spin A", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "")
	assert.ErrorIs(t, err, mbspin.ErrEmptyCreatedBy)
}

func TestUpdate_Success(t *testing.T) {
	headID := uuid.New()
	e, err := mbspin.New(headID, "Old Name", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
	require.NoError(t, err)
...
func TestNew_WithCCAndCostRateMkt(t *testing.T) {
	...
	cc := "CC-001"
	rate := 12.5
	e, err := mbspin.New(headID, "MB Spin B", nil, nil, nil, nil, nil, nil, &cc, &rate, nil, nil, nil, nil, "admin")
	require.NoError(t, err)
...
func TestUpdate_CCAndCostRateMkt(t *testing.T) {
	headID := uuid.New()
	e, err := mbspin.New(headID, "MB Spin C", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
	require.NoError(t, err)
...
func TestSoftDelete_AlreadyDeleted(t *testing.T) {
	headID := uuid.New()
	e, err := mbspin.New(headID, "Name", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "admin")
	require.NoError(t, err)
