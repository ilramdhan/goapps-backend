...
func TestNew_Success(t *testing.T) {
	e, err := machine.New("BT-D", "Barmag DTY", "DTY", "Plant A", 504, 1, 800.0, nil, 92.0, nil, "", "admin")
...
func TestNew_EmptyCode(t *testing.T) {
	_, err := machine.New("", "Barmag DTY", "DTY", "", 0, 1, 0, nil, 95, nil, "", "admin")
	assert.ErrorIs(t, err, machine.ErrEmptyCode)
}

func TestNew_EmptyName(t *testing.T) {
	_, err := machine.New("BT-D", "", "DTY", "", 0, 1, 0, nil, 95, nil, "", "admin")
	assert.ErrorIs(t, err, machine.ErrEmptyName)
}

func TestNew_EmptyCreatedBy(t *testing.T) {
	_, err := machine.New("BT-D", "Barmag DTY", "", "", 0, 1, 0, nil, 95, nil, "", "")
	assert.ErrorIs(t, err, machine.ErrEmptyCreatedBy)
}

func TestUpdate_Success(t *testing.T) {
	e, err := machine.New("BT-D", "Old Name", "", "", 0, 1, 0, nil, 95, nil, "", "admin")
	require.NoError(t, err)
	newName := "New Name"
...
func TestSoftDelete_Success(t *testing.T) {
	e, err := machine.New("BT-D", "Machine", "", "", 0, 1, 0, nil, 95, nil, "", "admin")
	require.NoError(t, err)
