...
* **finance:** add MB Spin candidate resolution by permanent ID for ambiguous codes ([99dfbb3](https://github.com/mutugading/goapps-backend/commit/99dfbb3abb4755fcc0e919aac7d2b833d901f395))
* **finance:** add MB Spin LDR provenance, recalc cascade, and lock-actual write path ([2e3958d](https://github.com/mutugading/goapps-backend/commit/2e3958d7b16ed3f9b1fbe1c5de23b1b8c81a1e76))
...
* **finance:** add mb_head shade sub-resource ([08854b7](https://github.com/mutugading/goapps-backend/commit/08854b72e87155003fb01048a5140f93a840498a))
* **finance:** add mb_spin duplication, lineage, recalc, and fixed-value flags ([95ccb4b](https://github.com/mutugading/goapps-backend/commit/95ccb4b9767232f4743f34bcbff8d03d4a283391))
...
* **finance:** add usage count to Shade master ([28d7a79](https://github.com/mutugading/goapps-backend/commit/28d7a79bd49710da9c7967ce6726d6083591be3f))
* **finance:** auto-generate one MB Spin row on first-ever MB Head validate ([ac4bac1](https://github.com/mutugading/goapps-backend/commit/ac4bac12c1d554bca5d207bb582158f938206e84))
* **finance:** copy Denier/Filament/Dozing/MB Costing/VS Number into auto-generated MB Spin ([972d092](https://github.com/mutugading/goapps-backend/commit/972d092afd11a772e386e05f9bc2b94058850806))
* **finance:** copy spec fields and VS Number to auto-generated MB Spin & fix MB Head shade code mapping ([#171](https://github.com/mutugading/goapps-backend/issues/171)) ([94b14ea](https://github.com/mutugading/goapps-backend/commit/94b14eac74a495beebd344c24e4b0b82e6dc16a6))
* **finance:** enforce composition sum rules and draft-state gating ([cff2f8d](https://github.com/mutugading/goapps-backend/commit/cff2f8d4e7f6df2e12a4ced5caf1092c7f87c8ee))
* **finance:** enhance MB Spin lifecycle, Shade master usage tracking, and RPC security ([64872dc](https://github.com/mutugading/goapps-backend/commit/64872dc84fa3084b60dfca35da17bb4de71a2ab4))
...
* **finance:** expose mbh_run_ldr_pct and register head LDR lookup readers ([bd1acff](https://github.com/mutugading/goapps-backend/commit/bd1acff77c853ecb3ac69afccaea562aac94e1f2))
* **finance:** expose mbs_run_ldr_pct and register LDR lookup readers ([2ab33e8](https://github.com/mutugading/goapps-backend/commit/2ab33e8cf18a45d9409c27e125998601ad78fe83))
* **finance:** extend mb_head workflow with check-status calc, reject/return-to-draft, and IAM notifications ([79cea37](https://github.com/mutugading/goapps-backend/commit/79cea37bc81e5e0c374b5278b84cf5d5f03a60fd))
* **finance:** filter mb_head list by cost product ([392e918](https://github.com/mutugading/goapps-backend/commit/392e918c0abe2ffde434a782a8fd3b674a5dc780))
...
* **finance:** guard manually-created cost products from MB workflow ([08ba605](https://github.com/mutugading/goapps-backend/commit/08ba605bf12b81da3544dba0766e43977a6a7249))
* **finance:** handle non-finite results and unimplemented formula types in cost calc ([edcaab2](https://github.com/mutugading/goapps-backend/commit/edcaab2472a0882567cc893ddb2b4cdfaabf4d6a))
...
* **finance:** link cost product parameter values to mb_spin ([fdd3753](https://github.com/mutugading/goapps-backend/commit/fdd37533b982e01f771bccc06d0ecfa6e3ad33ce))
...
* **finance:** register 5 MB_SPIN lookup columns missing from column registry ([f29c560](https://github.com/mutugading/goapps-backend/commit/f29c56093214a3cc70d30385d2ab7269db1e9777))
* **finance:** register MB_HEAD.mbh_ldr_prsn lookup column ([2464204](https://github.com/mutugading/goapps-backend/commit/2464204c333eea626696267ad825c8b9e50d7310))
* **finance:** register missing MB Spin reader columns for lookup fill ([618fcaf](https://github.com/mutugading/goapps-backend/commit/618fcaf70dd6168a90b7245bcaa5726a81a5478d))
...
* **finance:** update grpc permission mappings and add coverage ratchet test ([4aa6772](https://github.com/mutugading/goapps-backend/commit/4aa67729fd1e9fc4aaf10ec08fac4e76368c9aee))
* **finance:** warn on lookup column registry divergence at startup ([4fdf357](https://github.com/mutugading/goapps-backend/commit/4fdf357fff0709633674d618886ddf4f1d6ea068))
* **finance:** warn on unmapped lookup_source_column in remaining fill handlers ([b35f6c4](https://github.com/mutugading/goapps-backend/commit/b35f6c47ed68d73e8f48c5c0d227e384e5fc79a2))
...
* **finance:** add permission checks for 13 previously fail-open RPCs ([41b72a9](https://github.com/mutugading/goapps-backend/commit/41b72a9d8a2ebe42137eec62bf73ed6cbfdb8d5f))
...
* **finance:** fix invalid GROUP BY in cost import MB Spin resolution ([b6a9c1b](https://github.com/mutugading/goapps-backend/commit/b6a9c1bc32dd0fbd7920d889abf3a29d02294bca))
...
* **finance:** make MB Spin lookup deterministic on duplicate keys ([9893cd2](https://github.com/mutugading/goapps-backend/commit/9893cd2e3229dc613aa83b367709f4fd0fc77dc1))
...
* **finance:** source MB Head ShadeCode from mbh_code, not the unused mbh_shade_code field ([27ad342](https://github.com/mutugading/goapps-backend/commit/27ad34220209a7414f1516000dc039146a8c2081))
...
* **finance:** track .air.toml like iam/ppc for consistent hot reload ([638827a](https://github.com/mutugading/goapps-backend/commit/638827a5ea0e962a6b335829f95c8c749d903aa1))
...
* **finance:** add server-side search/pagination to lookup master options ([2d80e7e](https://github.com/mutugading/goapps-backend/commit/2d80e7e82244d8162bc3d5e05cc7e0b06433ddc6))
...
* **finance:** add approval visibility config to Parameter domain ([59cc021](https://github.com/mutugading/goapps-backend/commit/59cc02103ccef8c1d6427e232655a4f9a0720c34))
...
* **finance:** add backfill-mb-validate command for bulk VALIDATE ([69d98c5](https://github.com/mutugading/goapps-backend/commit/69d98c58083bda41b10c71247e94b8981a4c4f93))
...
* **finance:** implement MB batch costing backend ([673c395](https://github.com/mutugading/goapps-backend/commit/673c3958948e0b048c3cb772dec65000cd59e612))
...
* **finance:** migration 000432 — seed ORION_ITEM + DELIVERY_NO_OF_BOB as approval-visible params ([057782d](https://github.com/mutugading/goapps-backend/commit/057782dd8449237308f7a1a099a1b0dc862e38c1))
...
* **finance:** route list level/rm counts, fix sort, persist rm position + group name ([b907db5](https://github.com/mutugading/goapps-backend/commit/b907db5e5db81ae368394ebe2eb122b81a620ce9))
...
* **finance:** seed MB composition data from Oracle period 202606 ([04fb678](https://github.com/mutugading/goapps-backend/commit/04fb6786ceec175df1b0461b69a49d86a6da5245))
* **finance:** serve read-only cost master lookups for the PPC service ([5ad54dc](https://github.com/mutugading/goapps-backend/commit/5ad54dccf9799dea60bbfd156352e4418a468829))
* **finance:** surface display_group/order in GetParamSummary response ([bdb6028](https://github.com/mutugading/goapps-backend/commit/bdb60285d11c171372efe75ccf80e34d589b8dce))
...
* Calc Engine Concurrent Upsert Race and Orchestrator OOM Deadlocks ([c307148](https://github.com/mutugading/goapps-backend/commit/c3071482c368f5b8420ecf11095976088fe94c4c))
* **costcalc:** Export DB Pool Capacity Metric for Prometheus Alerting ([83fabe4](https://github.com/mutugading/goapps-backend/commit/83fabe40cf97a9a57f9e1ba1980fe415092cfea1))
* **costcalc:** export DB pool capacity so utilization can be computed ([bdfe9a7](https://github.com/mutugading/goapps-backend/commit/bdfe9a732a3a0a267ce29310eadcb6970cf6789e))
...
* **finance:** allow NULL group_head_id for MB/CARRIER composition rows ([f263707](https://github.com/mutugading/goapps-backend/commit/f263707b77015f3fd38fa79df5453550ba4e648d))
...
* **finance:** correct UOM integration test DB credentials + capture RETURNING id ([b079a22](https://github.com/mutugading/goapps-backend/commit/b079a22c00f3393e7d5353b1e213e692e83ce288))
...
* **finance:** extend timeout for long-running RPCs like TriggerMbBatch ([c479a91](https://github.com/mutugading/goapps-backend/commit/c479a91ea2eed52c4d49c2fe916ea3338b630501))
...
* **finance:** guard route unlink against LOCKED routing status ([088a8dd](https://github.com/mutugading/goapps-backend/commit/088a8dd26c391e1c7d082d98872064acb82b786d))
* **finance:** handle concurrent uk_cpc_active race in UpsertWithSupersede ([767fc29](https://github.com/mutugading/goapps-backend/commit/767fc29af8ed9f8ba646c0633e7b05c26767fa23))
...
* **finance:** remove stray MB param debug test breaking CI ([b455710](https://github.com/mutugading/goapps-backend/commit/b4557103838f0bc66a3a3a2f0d6d77f3e15db0b7))
...
* **finance:** resolve MACHINE_MB_FIXED_TOTAL to real machine cost instead of hardcoded 0 ([b5a8864](https://github.com/mutugading/goapps-backend/commit/b5a88640fff3dbc0730cfd2172b47e21d377a5c6))
...
* **finance:** seed self-contained USER fill task in SLA reminder e2e test ([34e4e5a](https://github.com/mutugading/goapps-backend/commit/34e4e5a8b3dfe6cdfb412f8ae1f0f5a6c9ab8f52))
* **finance:** seed self-contained USER fill task in SLA reminder e2e test ([#144](https://github.com/mutugading/goapps-backend/issues/144)) ([e3cd21b](https://github.com/mutugading/goapps-backend/commit/e3cd21b0fad9180e261879fd74c114b7204361c1))
...
* **finance:** use make_interval in ListOverdue to fix pgx OID-25 encoding error ([78ed2d1](https://github.com/mutugading/goapps-backend/commit/78ed2d159ba953f0beccf93e431e0b4ab60850a1))
...
* Resolve MB Machine Fixed Cost and Wire Machine Type Filter ([f762482](https://github.com/mutugading/goapps-backend/commit/f762482314d3d1b1a7eec94bb70efe354bc2d095))
