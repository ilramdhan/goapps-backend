...
## [0.16.0](https://github.com/ilramdhan/goapps-backend/compare/finance-service/v0.15.0...finance-service/v0.16.0) (2026-09-18)
...
* **finance:** add async import, export, template handlers for product_master, CAPP, CPP ([edd2ece](https://github.com/ilramdhan/goapps-backend/commit/edd2ece58b433d40198d26a21733fbbd4c774bf3))
...
* **finance:** add CostDataImportHandler gRPC delivery + extend cost_product_type and cost_product_master handlers ([16a4aad](https://github.com/ilramdhan/goapps-backend/commit/16a4aad7fbff98d20008009d15a139c07f8c648a))
* **finance:** add costimportjob domain entity + postgres repository ([c4b8fb9](https://github.com/ilramdhan/goapps-backend/commit/c4b8fb900b697f587676381696150f3effec2195))
* **finance:** add costing_import RabbitMQ routing + CostingImportHandler worker ([78f2934](https://github.com/ilramdhan/goapps-backend/commit/78f29344a8de401a7199659fad8f4dba589067a7))
...
* **finance:** add import/export/template handlers for cost_product_type ([5d4fc57](https://github.com/ilramdhan/goapps-backend/commit/5d4fc5735fe3b82eac73381af418f1329458586a))
...
* **finance:** add migrations 000381–000389 for Phase C gap plan ([b75b3db](https://github.com/ilramdhan/goapps-backend/commit/b75b3db627c90ffe787f29fedef314af4c59a8ef))
...
* **finance:** add shade_name/flex fields and BulkCreate/ListAll to CostProductMaster ([7f33986](https://github.com/ilramdhan/goapps-backend/commit/7f33986c0258e3d087c13f9ad8d1092cc854c446))
...
* **finance:** add yarn master CRUD — Machine, Intermingling, ProductGrade, MBHead, MBSpin, BoxBobbinCost ([cbdc988](https://github.com/ilramdhan/goapps-backend/commit/cbdc9883315a0a00b4542a593e6c120c7ea7d6f5))
...
* **finance:** enhance parameter import — CHAR→TEXT, INPUT default, UOM warn, costing columns ([c1c5a92](https://github.com/ilramdhan/goapps-backend/commit/c1c5a9258f0b5e15de57184e2251121558cbf2f9))
...
* **finance:** persist requesting_user_id in costing import jobs for notifications ([687bec8](https://github.com/ilramdhan/goapps-backend/commit/687bec86f035ffbca7e32d72509870d54a5c0516))
...
* **finance:** route lock tracking, param summary, enhanced lock/unlock handlers ([537c8cb](https://github.com/ilramdhan/goapps-backend/commit/537c8cbfd51efc96fb1d48cdbc21c5717ffe6daa))
...
* **finance:** T3 CalcType-aware LoadRMCosts + T5 fast-query cols in Result write path ([929df38](https://github.com/ilramdhan/goapps-backend/commit/929df3802a02f10db6801163de3bd1e034fe8ede))
...
* **finance:** use English for costing import completion notifications ([718cf02](https://github.com/ilramdhan/goapps-backend/commit/718cf0270467fc32c83928bfa01c87691bc228ea))
...
* **finance:** allow hyphens in parameter code validation pattern ([f1498ab](https://github.com/ilramdhan/goapps-backend/commit/f1498ab3527ceb18353adc9322f7155e4bc6a1fc))
...
* **finance:** auto-generate product_code on blank import rows ([f178e50](https://github.com/ilramdhan/goapps-backend/commit/f178e50ca456c00b94255a1969d12fbc18ecaa10))
...
* **finance:** extract repeated WHERE clause literal to shared constant ([a3c80e4](https://github.com/ilramdhan/goapps-backend/commit/a3c80e4c5c7b0ab930eb4e939049b49e513994fa))
...
* **finance:** fix cptExcelWriter undefined in costproducttype export handler ([c6cc071](https://github.com/ilramdhan/goapps-backend/commit/c6cc07131b833c1ef09a2ba84b5fe77d1025af81))
...
* **finance:** fix param_id UUID propagation and implement ListParamEditLog ([1fc0fb3](https://github.com/ilramdhan/goapps-backend/commit/1fc0fb317528040a93be8455aac874635b5ed4f6))
* **finance:** fix parameter unique violation detection for pgx/v5 driver ([f7e9939](https://github.com/ilramdhan/goapps-backend/commit/f7e9939031206f1f00cd83cf8212306f808a7d2e))
...
* **finance:** fix yarn master list queries and seed data integrity ([dbec28a](https://github.com/ilramdhan/goapps-backend/commit/dbec28a47bc48f8480af23be6dcd70875d9ea478))
...
* **finance:** replace interface{} with any in CostProductParameterRepository ([ec6f5aa](https://github.com/ilramdhan/goapps-backend/commit/ec6f5aaa55b00cca285f47ac9fd94ef955e65d83))
...
* **finance:** skip unchanged params in override audit log ([94ff8f7](https://github.com/ilramdhan/goapps-backend/commit/94ff8f741d60487f5e614d17ac2c4ff89597396a))
...
* **finance:** suppress unused fileName param in enqueueImport helper ([22350c9](https://github.com/ilramdhan/goapps-backend/commit/22350c90fde3088cd51d02d7e4f272508a1361bb))
...
* **lint:** fix gofmt alignment in cost_product_request_handler ([fcf456b](https://github.com/ilramdhan/goapps-backend/commit/fcf456b63ef6ee946fba214656ca76a28d5ab15c))
* **lint:** gofmt cost_product_type_handler.go ([78abd1e](https://github.com/ilramdhan/goapps-backend/commit/78abd1e806a50e533af3632704cb2668a8ebd61b))
* **lint:** gofmt remaining finance delivery and server files ([653211b](https://github.com/ilramdhan/goapps-backend/commit/653211bb0864d23bb6adafed826cba88c64dff32))
