...
## [0.16.0](https://github.com/ilramdhan/goapps-backend/compare/finance-service/v0.15.0...finance-service/v0.16.0) (2026-09-04)
...
* **finance:** add cost_request_status_history table and requesthistory domain package ([1129480](https://github.com/ilramdhan/goapps-backend/commit/11294800afc7be704164e7bf792b9d7ae2a1fd1f))
...
* **finance:** add CPRNotifier interface and IAM-backed implementation for rule-based CPR notifications ([fcd1d47](https://github.com/ilramdhan/goapps-backend/commit/fcd1d47e419e850de8a1ff4947613d00204757d2))
...
* **finance:** add fill-assignment config CRUD application handlers ([5e7697b](https://github.com/ilramdhan/goapps-backend/commit/5e7697b031c4aa60254315d807ca18e027d89da6))
* **finance:** add fill-assignment tracking query, overrides, SLA cron, resolver ([40720e7](https://github.com/ilramdhan/goapps-backend/commit/40720e708c31892d309da6e23bce7eb04f6da906))
* **finance:** add fill-task lifecycle application handlers ([d64288c](https://github.com/ilramdhan/goapps-backend/commit/d64288c5552a87c1e23b620072e5f9bdce16fc11))
* **finance:** add FillEventNotifier interface and IAM implementation; fix DEPT fill task notification gap ([718d459](https://github.com/ilramdhan/goapps-backend/commit/718d4599bdd329bc8137ca7691c42741e85ba67c))
* **finance:** add IAM workflow client seam + best-effort Submit wiring ([a74c90a](https://github.com/ilramdhan/goapps-backend/commit/a74c90a34a04ba7c2c6c81dbd1ec1a89ace80afb))
...
* **finance:** add postgres fill-config + fill-task repositories ([9e71ad8](https://github.com/ilramdhan/goapps-backend/commit/9e71ad89916c54c4a49751e1ea103fb1832210ad))
...
* **finance:** add RequestNotification method to iamclient.NotificationClient ([a059178](https://github.com/ilramdhan/goapps-backend/commit/a059178e0aee385b54ee5042a4c57833a455b6e2))
...
* **finance:** hook FillTaskCreator into MarkParameterPending ([825e912](https://github.com/ilramdhan/goapps-backend/commit/825e9123631808533eb30e162d88ee8d501c3728))
...
* **finance:** seed fill-assignment global configs + test task data ([5f7be85](https://github.com/ilramdhan/goapps-backend/commit/5f7be8513985d2368c105699f92ce34979137d94))
...
* **finance:** wire CPR notification events in all state transitions; remove old AssignedToUserID-based notification ([7defd99](https://github.com/ilramdhan/goapps-backend/commit/7defd99651c2b0d55172afe8da3bcd7fe130cc1f))
* **finance:** wire fill-assignment gRPC handlers into delivery + main ([c67d154](https://github.com/ilramdhan/goapps-backend/commit/c67d15495a0cf327bfb9a4f3fea1aac8a192356e))
* **finance:** wire IAM notification client and route CPR/fill events through IAM fan-out ([afc67a5](https://github.com/ilramdhan/goapps-backend/commit/afc67a51d4f510495a5e3e040ac3c38f91731c10))
...
* **finance:** correct CPR_DRAFT_CREATED notification recipients and split creator ack ([206d43a](https://github.com/ilramdhan/goapps-backend/commit/206d43ad168f37d5100a10c30e8307aea90469f9))
...
* **finance:** renumber duplicate migration 000365 → 000366/000367 ([bb4c019](https://github.com/ilramdhan/goapps-backend/commit/bb4c019f9525e94fdbea7a07cf4db3af9c06a47f))
...
* lint sweep for fill-assignment — package comment + rows.Close errcheck ([a1bc9c9](https://github.com/ilramdhan/goapps-backend/commit/a1bc9c95ed79dad7429e3e0ba44c30c4d3b337a2))
